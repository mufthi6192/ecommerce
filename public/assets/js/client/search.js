$(document).ready(function () {
    ...
    let fullUrl = '/client/search/all-data/'+keyword
    ...
    $('#pagination-container').pagination({
        ...
        callback: function(data, pagination) {
            ...
            for(let i in data){
                ...
                $("#list-product").append(renderProduct(image, category, name, price, id))
            }
    ...
    function renderProduct(image,category,name,price,id){
                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                                                <li class="quickview"><a href="/client/product/${id}"><i class="far fa-eye"></i></a></li>
